...
// @module ListHeader
define('SerialNumberReport.ListHeader.View'
,	[
		'SC.Configuration'
	...
	,	'serial-number-report_list_header_view.tpl'
	...
	)
{
	...
	,	events: {
		...
		,	'keyup [data-action="serialNumber"]': 'serialNumber'
		}
	...
	,	getContext: function()
		{
			...
			,	filters: this.filters
				...
				// @property {Array} filtersProject

			, 	serialnumbername : this.selectedSerialNumber
	...
	,	serialNumber: function (e)
		{
			...
			this.selectedSerialNumber = e.target.value;
	...
	,	setSelecteds: function ()
		{
			...
			this.selectedSerialNumber = this.getSerialNumberFromUrl(url_options.serialnumber);
	...
	,	getSerialNumber: function (value)
		{
			return value;
		}
	...
	,	getFilterFromUrl: function (url_value)
		...
		// @method getFilterFromUrl @param {String} url_value @returns {Object} the selected filter from the url
		// or the default filter if no value set up
	,	getSerialNumberFromUrl: function (url_value)
		{
			return this.getSerialNumber(url_value) || this.getDefaultSerialNumber();
		}
	...
	,	getDefaultSerialNumber: function ()
		{
			return this.defaultSerialNumber || (this.defaultSerialNumber = _.findWhere(this.selectedSerialNumber , {selected: true}) || _.first(this.selectedSerialNumber ));
		}
	...
	,	getDefaultDisplay: function ()
		...
		// @method isDefaultStages @returns {Boolean}
	,	isDefaultSerialNumber: function (serialnumber)
		{
			return this.getDefaultSerialNumber() === serialnumber;
		}
	...
	,	updateUrl: function ()
		{
			...
			//Serial Number
			url = this.selectedSerialNumber == ""  || this.selectedSerialNumber == undefined ?
				_.removeUrlParameter(url, 'serialnumber') :
				_.setUrlParameter(url, 'serialnumber', _.isFunction(this.selectedSerialNumber) ? this.selectedSerialNumber.apply(this.view) : this.selectedSerialNumber);
